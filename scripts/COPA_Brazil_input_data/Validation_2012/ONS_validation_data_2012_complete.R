...
#SE_summary_plots <- multiplot(lines_together, plot_points_hydro,plot_points_thermal)
#ggsave("C:/Users/cancella/Google Drive/!IIASA/COPA/runs/Validation_2012/figures/SE/summary_se.pdf",SE_summary_plots,width=50,height=50,units="cm")
